...
categories_to_select = {
    "Food": "Aardbeien|Zuivelhoeve|2Bruder|Groente Fruit|Food|Pindakaaswinkel|Too Good To Go|Bakker Bart|Chocolaterie|van Heeswijk Eersel|Patisserie|Xaris Lunet Zorg|Sodexo|BIERENS VOF GEBAK|Miss Bettie|Jan Linders|Mitra|Bakkerij|^AH |Albert Heijn|Jumbo|Lidl|Aldi|Sligro|Ekoplaza|Hema|IZMIR|Ozturk|NETTORAMA|TooGoodToGo|VieCuri|Maxima MC|Rudolf Vermeulen|De Genneper Hoeve|SumUp|Tonys Chocolonely|INTERMARCHE",
    "Non-food": "SoLow |America Today|Dragon Tattoo|Van alles en meer|Secrid|Holland.*Barrett|Perry Sport|Zalando|Interoffice|Intersport|De Paskamer|Etos|Intelbazaar|Schoen|Snipes|Travelbags|Hunkemoeller|Smartphonehoesjes|YourSurprise|Coolblue|Stichting Kringloo|Dikke Mik|HORNBACH|PANDORA|ONLY |ZEEMAN|Timco|clothing|Clay And Glow|Costes Eindhoven|MINISO|Parfumerie|Cosmetics|Xenos|Fashion|STRADIVARIUS|Decathlon|Bijenkorf|Bistro|Wibra|PRIMARK|vanHaren|Jewellery|Kadoshop|Planten|Bever|The Sting|Action|Kruidvat|RitualsCosmetics|Praxis|Karwei|IKEA|Amazon|bol\.*com|Bershka|Bruna|Tochgoedkoopnl|^CA|^HM|Hennes .*Mauritz|Pull.*Bear|Amsterdam SAL FO|Lucardi|Favoloso|Nelson|New York Finest shirts|Muco Amsterdam|Bloemerie|Wehkamp",
    "Hobby": "BOEKEN|CCVPipoos|Boekhandel|Waterstones|Paagman|Keyboardcentrum|Zingende Snaar|STRIPSPECIALIST|Techniparts|Goed Gemerkt|TinyTronics|Onlinekabelshop|123 3D|123accu|Otronic|Opencircuit|Mouser Electronic|HOD Electronics|Conrad|Eleshop|Reichelt|RECORD SHOP",
    "Tikkie": "Tikkie|Betaalverzoek",
    "Auto": "Auto|parking|Verkeersboetes|Tankstation|Q8 AIRE|^OK |Esso|TotalEnergies|Total |P Centrum Breda|EXPRTILBURG|KEIZ3320|TMCP|GARAGE VAN OOL|Shell|TINQ|^BP|TAMOIL|ANWB|KAMPEN ASSURANTIE|VKG VERZEKERINGEN|MijnAutoOnderdelen|Interparking|ParkBee|Q-Park|QPark|79-KDL-1",
    "Openbaar vervoer": "NS GROEP",
    ...
    "Inboedel": "Pelletkachel|Pronto Wonen|Kachelpijpen|Haarden|Meubella|Planten|Praxis|Matt Sleeps|ABC Webshop|Vloerglijders\.nl|groenovatie|Tuincentrum|Intratuin|TuincentrCoppelmans|Pimpernelzorgkw|vijver|Randijk Bamboe|VenetaBV|boom kappen",
    ...
    "Abonnementen": "Surfshark|Piano|PLINQ|DPG MEDIA|Simyo|MICROSOFT|Kosten OranjePakket|Kosten tweede rekeninghouder",
